...
public:
  ...
  double next_double(double upper_bound) {
    return next_double()*upper_bound;
  }

  double next_double(double lower_bound, double upper_bound) {
    return next_double()*(upper_bound-lower_bound) + lower_bound;
  }
